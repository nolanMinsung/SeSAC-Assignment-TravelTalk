...
struct ChatData {
    ...
    static var list: [ChatRoomModel]? = ChatList.list.compactMap { try? ChatRoomModel.from(dto: $0) }
    
//    static var list: [ChatRoomModel] = [
//
//        ChatRoom(chatroomId: 1,
//                 chatroomImage: "Sanlio",
//                 chatroomName: "영등포캠퍼스 멘토진방",
//                 chatList: [
//                    Chat(user: UserData.hue,
//                         date: "2025-07-12 21:30",
//                         message: "열심히 일 하시고 계시는거죠?"),
//                    Chat(user: UserData.bran,
//                         date: "2025-07-12 22:32",
//                         message: "3층 가고싶어요..."),
//                    Chat(user: UserData.finn,
//                         date: "2025-07-12 22:38",
//                         message: "화이팅!!"),
//                    Chat(user: UserData.jack,
//                         date: "2025-07-12 22:38",
//                         message: "으앙"),
//                    Chat(user: UserData.den,
...
//                    Chat(user: UserData.other_friend,
